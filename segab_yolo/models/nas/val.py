...
class NASValidator(DetectionValidator):
    """segab_yolo YOLO NAS Validator for object detection.

    Extends DetectionValidator from the segab_yolo models package and is designed to post-process the raw predictions
