...
class NASPredictor(DetectionPredictor):
    """segab_yolo YOLO NAS Predictor for object detection.

    This class extends the DetectionPredictor from segab_yolo engine and is responsible for post-processing the raw
    ...
    def postprocess(self, preds_in, img, orig_imgs):
        ...
        post-processing operations to generate the final detection results compatible with segab_yolo result
