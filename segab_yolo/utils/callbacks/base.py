...
"""Base callbacks for segab_yolo training, validation, prediction, and export processes."""
...
def get_default_callbacks():
    """Get the default callbacks for segab_yolo training, validation, prediction, and export processes.
