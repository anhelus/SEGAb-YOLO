"""
Legacy Bi-Level Routing Attention (BiFormer) — *unused*.

These components were used by the original BiFormer implementation and
have since been refactored into the main module set.  This file is kept
